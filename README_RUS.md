...
1. На протяжении всего курса тебя будет сопровождать чувство неопределенности и острого дефицита информации - это нормально. Не забывай, что информация в репозитории и Google всегда с тобой. Как и пиры, и Slack. Общайся. Ищи. Опирайся на здравый смысл. Не бойся ошибиться.
...
3. Для одного US разработай критерии приемки, описать:
...
3. При обсуждении проверь три характеристики INVEST:
   ...
   2. обсуждаемость каждого US: получилось ли обсудить с «пользователем», «заказчиком», «разработчиком» - укажи, к каким выводам пришли;
...
5. Укажи свои ответы в файле ex02\_<префикс продукта>\_us.docx.

💡 [Нажми сюда](https://forms.yandex.ru/cloud/65b90985c09c0208f7f1dad7/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Продукта сделать твоё обучение лучше.